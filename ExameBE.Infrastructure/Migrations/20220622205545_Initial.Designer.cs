...
namespace ExameBE.Infrastructure.Migrations
{
    ...
    [Migration("20220622205545_Initial")]
            ...
            modelBuilder.Entity("ExameBE.Domain.Model.Anuncio", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AdType = 0,
                            CreationDate = new DateTime(2022, 6, 22, 21, 55, 44, 561, DateTimeKind.Local).AddTicks(8480),
                        ...
                        new
                        {
                            Id = 2,
                            AdType = 2,
                            CreationDate = new DateTime(2022, 6, 22, 21, 55, 44, 579, DateTimeKind.Local).AddTicks(7840),
                        ...
                        new
                        {
                            Id = 3,
                            AdType = 1,
                            CreationDate = new DateTime(2022, 6, 22, 21, 55, 44, 579, DateTimeKind.Local).AddTicks(8540),
                            Description = "Revisão feita sempre na marca. Como novo.",
                            Subject = "Mazda CX-5, 2018, 40000 Km, 27000€"
                        });
                });
